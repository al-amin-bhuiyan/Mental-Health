...
class AddJournalPage extends StatelessWidget {
  ...
  const AddJournalPage({super.key, this.verse, this.reference, this.mood});
  ...
  Widget _buildMoodSelectionBox(AddJournalController controller) {
    return Container(
      width: double.infinity,
  ...
  Widget _buildMoodItem(
    AddJournalController controller,
    String icon,
    String label,
  ) {
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              SvgPicture.asset(icon, width: 20.w, height: 16.h),
              SizedBox(height: 4.h),
              Text(
                label,
  ...
  Widget _buildTimestamp() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(width: 0.20, color: Color(0xFFB5B5B5)),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
  ...
  Widget _buildJournalTitleSection(AddJournalController controller) {
    return Container(
      width: double.infinity,
      padding: EdgeInsets.all(16.w),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(12.r),
        border: Border.all(width: 1.w, color: Color(0xFF727272)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  Widget _buildWriteEntrySection(AddJournalController controller) {
    return Container(
      width: double.infinity,
      padding: EdgeInsets.all(16.w),
      decoration: BoxDecoration(
            ...
            child: Column(
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        'Today I\'m grateful for the warm sunlight streaming through my window and the quiet moments of peace...',
                    hintStyle: TextStyle(
                      color: Color(0xFFAEAEAE),
                      fontSize: 12.sp,
                      fontFamily: 'Urbanist',

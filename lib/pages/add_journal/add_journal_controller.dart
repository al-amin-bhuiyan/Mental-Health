...
class AddJournalController extends GetxController {
  ...
  final smileController = TextEditingController();
  ...
  final moods = [
    {'icon': 'assets/icons/happy.svg', 'label': 'Happy'},
    {'icon': 'assets/icons/anxious.svg', 'label': 'Anxious'},
    {'icon': 'assets/icons/calm.svg', 'label': 'Calm'},
    {'icon': 'assets/icons/angry.svg', 'label': 'Angry'},
    {'icon': 'assets/icons/aweful.svg', 'label': 'Awful'},
  ];
